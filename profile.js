...
var PROFILE_DATA = {
    personal: {
        ...
        summary: "An ambitious dreamer and well-rounded leader seeking knowledge across disciplines. Passionate about building secure, scalable financial technology solutions."
    },
    organizationalRoles: [
    ...
    skills: [
        ...
        { name: "SQL", icon: "fas fa-database", color: "text-cyan-500" },
    ...
    experience: [
        {
            ...
            color: "red",
            logo: "PNG/Programming_Hero.jpeg",
        ...
        },
        {
            ...
            color: "teal",
            logo: "PNG/Youth Upskill Network.png",
        ...
        },
        {
            ...
            color: "rose",
            logo: "PNG/International Leadership Competition.jpeg",
    ...
    projects: [
        {
            ...
            image: "PNG/Mango Star.png",
            techStack: ["React", "TypeScript", "Supabase", "Tailwind CSS", "TanStack Query", "Node.js", "Express.js", "PostgreSQL", "Stripe"],
            description: "A modern full-stack e-commerce platform built for seamless online shopping with secure authentication, real-time database integration, product management, shopping cart, order tracking, and responsive user experience.",
            liveUrl: "https://mangostar.store",
            githubUrl: "https://github.com/masudul2002",
            extraInteractivity: true,
            bullets: [
        ...
        },
        {
            ...
            description: "End-to-end accounting and member management platform for Dhipidanga Jubo Shongha. Features RBAC, financial dashboards, live alerts, responsive sidebar navigation, and Bengali report generation.",
            liveUrl: "https://djs-org.vercel.app",
            githubUrl: "",
            extraInteractivity: false,
            bullets: [
        ...
        },
        {
            ...
            image: "",
            techStack: [],
            description: "Details about an ongoing or planned project. Stay tuned for more amazing work.",
            liveUrl: "#",
            githubUrl: "",
            extraInteractivity: false,
            isPlaceholder: true,
    ...
    targetPositions: {
        ...
        ft: {
            ...
            summary: "Computer Science and Engineering undergraduate with a strong focus on financial technology, secure payment systems, and web development. Built a production-ready payment portal integrating bKash QR-code payment, PDF receipt generation with unique transaction IDs, and a mandatory compliance workflow. Combines hands-on API integration experience with analytical problem-solving skills and leadership in technology-driven community initiatives. Eager to deliver secure, scalable FinTech solutions.",
            skills: [
